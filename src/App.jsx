      ...
      <footer className='border-top'>
        <div className='px-4 my-4 text-center'>
          <ul className="nav justify-content-center mb-3 alignItemsCenter">
            ...
            <li className="nav-item"><a href="https://github.com/divyesh-jani/" target="_blank" data-bs-toggle="tooltip" data-bs-title="Github Account" data-bs-custom-class="custom-bs-tooltip"><img src="https://divyeshjani.github.io/shared/img/github.png" className="nav-link px-2 text-body-secondary social" alt="Github" /></a></li>
            <li className="nav-item"><a href="https://divyeshjani.com" target="_blank" data-bs-toggle="tooltip" data-bs-title="Divyesh Jani Portfolio" data-bs-custom-class="custom-bs-tooltip"><img src="https://divyeshjani.github.io/shared/img/favicon.png" className="nav-link px-2 text-body-secondary social-lg" alt="DivyeshJani.com" /></a></li>
            <li className="nav-item"><a href="mailto:contact.djani@gmail.com?subject=Hello from your website" data-bs-toggle="tooltip" data-bs-title="Email Divyesh" data-bs-custom-class="custom-bs-tooltip"><img src="https://divyeshjani.github.io/shared/img/email.png" className="nav-link px-2 text-body-secondary social" alt="Email" /></a></li>
            <li className="nav-item"><a href="https://divyesh.org" target="_blank" data-bs-toggle="tooltip" data-bs-title="Donate" data-bs-custom-class="custom-bs-tooltip"><img src="https://divyeshjani.github.io/shared/img/donate.png" className="nav-link px-2 text-body-secondary social" alt="Divyesh.org" /></a></li>
          </ul>
